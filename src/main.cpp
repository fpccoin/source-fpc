...
const string strMessageMagic = "fpc Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
            ...
            int64_t nSubsidy = 393 * COIN;

            if(nBestHeight == 0)
            {
            nSubsidy = 41265000 * COIN;
            }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "fpc", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1499079912, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "dfdfujkyg";
        CTransaction txNew;
        txNew.nTime = 1499079912;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1499079912;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 145188 : 145188;
        ...
        assert(block.hashMerkleRoot == uint256("0xecc979e53952082bbf9aa0fca839c96cd703c111537241e002f6963172dea26b"));
...
unsigned char pchMessageStart[4] = { 0x3e, 0xa6, 0x14, 0xdd };
